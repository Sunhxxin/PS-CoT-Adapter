...
def T5Trainer(
    ...
    if args.evaluate_dir is not None:
        ...
        #save_dir = "answer_20_frozen_semantic_model_random_01"
        #save_dir = "/data/mm-cot-main/models/frozen_semantic_model_rational01/"
    ...
    if args.img_type is not None:
        ...
        if args.load_checkpoint is not None:
            # 创建模型
            model = T5ForMultimodalGeneration.from_pretrained(args.load_checkpoint, patch_size=patch_size, padding_idx=padding_idx, save_dir=save_dir,ignore_mismatched_sizes=True)
